...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template2: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template2(MainView parent, MainView parentInstance): base("showData", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::ShowDataPage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "showData";
    }
    ...
    void InitializeUX()
    {
        ...
        var showData = new Template2(this, this);
        this.Background = float4(0.4196078f, 0.3490196f, 0f, 1f);
        temp17.Style = Fuse.Platform.StatusBarStyle.Light;
        temp18.Color = float4(1f, 0.5882353f, 0.2980392f, 1f);
        router.Name = __selector0;
        temp19.Children.Add(temp20);
        temp20.DefaultPath = "splash";
        temp20.Templates.Add(splash);
        temp20.Templates.Add(home);
        temp20.Templates.Add(showData);
